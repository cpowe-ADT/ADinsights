...
**Purpose:** step-by-step staging-environment smoke test for the GA4 web-analytics surface. Operator-runnable walkthrough to close the one unchecked DoD item from `artifacts/roadmap/prompts/finish-ga4.md` — *"Dashboard at `/dashboards/google-analytics` shows real data on the dev stack."*
...
2. Update `artifacts/roadmap/project-punchlist.md` Quick status row for GA4:
   - If all green: 80% → 100% + add note: *"Staging regression green <YYYY-MM-DD>; live end-to-end verified."*
