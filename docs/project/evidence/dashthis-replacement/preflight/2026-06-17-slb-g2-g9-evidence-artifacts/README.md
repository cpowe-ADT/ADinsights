# SLB G2-G9 Evidence Artifact Validation Preflight
...
```text
Assess SLB G2-G9 evidence artifact validation for DashThis cancellation readiness
```
...
- Local validator change: G2-G9 filled runs now require existing, non-empty local evidence
  artifacts under `docs/project/evidence/dashthis-replacement/`, with expected suffixes, JSON
