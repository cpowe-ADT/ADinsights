...
class IntegrationOAuthCallbackSerializer(serializers.Serializer):
    code = serializers.CharField()
    state = serializers.CharField()
...
class IntegrationProvisionSerializer(serializers.Serializer):
    external_account_id = serializers.CharField(required=False, allow_blank=True)
    workspace_id = serializers.UUIDField(required=False, allow_null=True)
    ...
    source_configuration = serializers.JSONField(required=False, allow_null=True)
    ...
    schedule_type = serializers.ChoiceField(
        ...
        required=False,
        default=AirbyteConnection.SCHEDULE_CRON,
    )
    interval_minutes = serializers.IntegerField(required=False, allow_null=True, min_value=1)
    cron_expression = serializers.CharField(required=False, allow_blank=True)
    ...
    def validate(self, attrs: dict[str, object]) -> dict[str, object]:
        ...
        cron_expression = str(attrs.get("cron_expression", "") or "").strip()
