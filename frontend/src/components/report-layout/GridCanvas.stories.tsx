...
const compactLayout: DashboardLayoutConfig = {
  ...
  rowHeight: 72,
  widgets: [
    { id: 'a', type: 'kpi', title: 'Spend', x: 1, y: 1, w: 3, h: 2, data: 478000, options: { format: 'currency', currency: 'JMD' } },
    { id: 'b', type: 'gauge', title: 'Pacing', x: 4, y: 1, w: 3, h: 2, data: 0.82, options: { max: 1.2, unit: '%' } },
    {
      id: 'c', type: 'bar', title: 'By parish', x: 1, y: 3, w: 6, h: 3,
      data: [
...
export const WithLiveDataResolver: Story = {
  args: {
    ...
    resolveData: (widget) => (widget.id === 'kpi-followers' ? 6100 : undefined),
  },
};
