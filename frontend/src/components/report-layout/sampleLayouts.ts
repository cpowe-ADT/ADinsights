...
export const liveDashboardLayout: DashboardLayoutConfig = {
  ...
  widgets: [
    ...
    },
    {
      ...
      w: 3,
      h: 2,
      dataKey: 'summary.totalConversions',
      options: { format: 'number' },
    },
    {
      id: 'roas',
      ...
      w: 3,
      h: 2,
      dataKey: 'summary.averageRoas',
      options: { format: 'rate' },
    },
    {
      id: 'parish-spend',
      type: 'bar',
      title: 'Spend by parish',
      x: 1,
      y: 3,
      w: 7,
      h: 4,
      dataKey: 'parish.spend',
      options: { currency: 'JMD', height: 220 },
    },
    {
      id: 'parish-clicks',
      type: 'pie',
      title: 'Clicks by parish',
      x: 8,
      y: 3,
      w: 5,
      h: 4,
      dataKey: 'parish.clicks',
      options: { height: 220 },
    },
    {
      id: 'parish-table',
